        ...
        <div className={this.state.mainClassName}>
          <div className="card-responsive-list">
            <Card bordered={false}
              ...
              <div style={{ padding: '0.5em', textAlign: 'center' }}>On this
                page
                you can view all
            ...
            <Card bordered={false}
              ...
              <div style={{ padding: '0.5em', textAlign: 'center' }}>On this
                ...
                away, or make them visible only to you, for later edit&add to
                the
                website.
              </div>
            </Card>
            <Card bordered={false}
              ...
              <div style={{ padding: '0.5em', textAlign: 'center' }}>Here you
                can
                manage product categories available on the website. Every
                category
